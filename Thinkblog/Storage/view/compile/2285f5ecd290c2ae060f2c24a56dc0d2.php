		...
		<div class="left_content">
			...
			<div class="content_box">
				<div class="title_info">
                    <div class="title"><a href="javascript:;"><?php echo $data['title']?></a></div>
                    <div class="cate_info">
                        <span>作者:<?php echo $data['author']?></span>&nbsp;&nbsp;
                        <span><i class="icon iconfont">&#xe61b;</i> <?php echo date('Y-m-d H:i:s')?></span>&nbsp;
                        <span>分类:<a href="con-l<?php echo $data['cid']?>.html"><?php echo $data['cname']?></a></span>
                    </div>
				...
				<div class="info">
                    ...
                    <a class="good"  href="con-t<?php echo $v['tid']?>.html"><?php echo $v['tname']?></a><span>、</span>
                    <?php }?>
                    <a class="time" href="avascript:void(0);"><i class="icon iconfont">&#xe670;</i> <?php echo $data['click']?></a>
