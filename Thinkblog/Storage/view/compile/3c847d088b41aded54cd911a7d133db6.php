<div class="footer">
	...
	<ul id="connect">
		<li id="fi">联系</li>
		<li class="so"><i class="icon iconfont">&#xe65f;</i><?php echo C('webset.adminqq')?></li>
		<li class="so"><i class="icon iconfont">&#xe674;</i><?php echo C('webset.adminweibo')?></a></li>
		<li class="so"><i class="icon iconfont">&#xe63b;</i><?php echo C('webset.adminweixin')?></a></li>
	</ul>
